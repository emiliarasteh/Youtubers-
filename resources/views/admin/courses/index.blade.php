                ...
                @foreach($courses as $value)
                    <tr>
                        ...
                        <td>
                            ...
                            <!-- modals -->
                            <!-- Large modal -->
                            <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target=".bs-example-modal-lg{{$value->id}}">Edit</button>
                                            ...
                                            <form class="form-label-left input_mask" method="post" action="{{route('admin.update', $value->id)}}"
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9 col-sm-9 ">
                                                        <input value="{{$value->title}}" name="title" type="text" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-form-label col-md-3 col-sm-3 ">Description</label>
                                                    <div class="col-md-9 col-sm-9 ">
                                                        <input value="{{$value->description}}" name="description" type="text" class="form-control">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9 col-sm-9 ">
                                                        <input value="{{$value->price}}" name="price" type="number" class="form-control">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9 col-sm-9 ">
                                                        <input value="{{$value->duration}}" name="duration" type="number" class="form-control">
                                                    </div>
                                                </div>
